...
4. 安装程序：在文件目录"`/opt/`"下，使用命令`rpm -ivh mysql-***`。注意：必须严格按照安装顺序进行。
    ![image-20220418084447901](./imgs/mysql安装顺序.png)
    
    报错信息：
    
    1. 在第二步时，可能报以下错误：
    
        ![image-20220418085912918](./imgs/安装mysql报错_1.png)
    ...
    2. 在第三步时，可能报错
        ...
        ![image-20220418090938420](./imgs/安装mysql报错_2.png)
    ...
    3. 在最后一步时，有以下信息
        ...
        ![image-20220418091815609](./imgs/安装mysql报错_3.png)
...
5. 服务初始化：
    ...
    ![image-20220418093011775](./imgs/查看密码.png)
...
5. 报错2058：
    ...
    ![image-20220418104228838](./imgs/mysql连接错误.png)
...
6. 报错`SSH`：
    ...
    ![image-20220418105745294](./imgs/mysql连接错误_SSH.png)
...
2. 用本地命令行窗口连接数据库，之后输入命令`show processlist`，得到下面结果。
    ...
    ![image-20220419164926409](./imgs/我的公网地址.png)
