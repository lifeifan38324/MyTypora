...
6. 所有命令
    ...
    ![image-20220421155249641](./imgs/vim指令)
...
- 虚拟网络关系:
    ...
    ![image-20220422214156890](imgs/虚拟网络关系)
...
1. `ll`查看文件权限
    ...
    ![image-20220423202203750](./imgs/文件权限)

2. 文件属性

    ![image-20220423203139826](./imgs/文件属性)
...
3. `tar [选项] [XXX.tar.gz]`打包归档
    ...
    - 选项说明
        ...
        ![image-20220423212108557](./imgs/tar工具的选项)
...
3. `df [-h]`空余磁盘
    ...
    ![image-20220423224503087](imgs/内存硬盘空间1)

4. `free -h`查看内存使用情况

   ![image-20220423224810034](imgs/内存硬盘空间2)

5. `lsblk`显示挂载点详细信息

    ![image-20220423225601978](imgs/挂载点信息)
...
6. 挂载/卸载光驱
    ...
    - 设置开机自动挂载：`vim /etc/fstab`
        ...
        ![image-20220424082942586](imgs/光盘挂载信息)
...
## 9.进程管理类
   ...
   2. `ps [选项aux|-ef] [|grep ...]`：查看进程。
       ...
       ![image-20220424122011696](imgs/进程信息说明)
...
2. 命令：`crontab`
    ...
    - 格式：
        ...
        ![image-20220424154301601](imgs/定时任务格式)

        ![image-20220424154338180](imgs/定时任务通配符)

        ![image-20220424154420180](imgs/例子)
...
1. `yum [-y安装中全回答yes] [参数]`
    ...
    ![image-20220424161413468](imgs/YUM安装包参数说明)
...
2. 修改镜像文件源：配置文件`/etc/yum.repos.d`
    ...
    ![image-20220424164127323](imgs/修改默认镜像源1)
    
    ![image-20220424164913588](imgs/修改默认镜像源2)
...
3. 数值判断：
    ...
    ![image-20220430171852662](imgs/数值判断)

4. 文件权限判断：

    ![image-20220430171940742](imgs/文件权限判断)

5. 文件类型判断：

    ![image-20220430172019968](imgs/文件类型判断)
...
![image-20220501104708194](imgs/awk工具)
